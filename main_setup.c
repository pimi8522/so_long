...
/*   Updated: 2025/08/11 16:25:10 by miduarte         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void load_idle_sprites(t_vars *vars)
{
	...
	vars->sprites.idle[0] = mlx_xpm_file_to_image(vars->mlx, "./assets/idle0.xpm", &w, &h);
	vars->sprites.idle[1] = mlx_xpm_file_to_image(vars->mlx, "./assets/idle1.xpm", &w, &h);
	vars->sprites.idle[2] = mlx_xpm_file_to_image(vars->mlx, "./assets/idle2.xpm", &w, &h);
	vars->sprites.idle[3] = mlx_xpm_file_to_image(vars->mlx, "./assets/idle3.xpm", &w, &h);
	vars->sprites.idle[4] = mlx_xpm_file_to_image(vars->mlx, "./assets/idle4.xpm", &w, &h);
}
