...
#    Updated: 2025/08/12 14:57:26 by miduarte         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS        = main.c map.c fail_textures.c main_setup.c move_player.c player.c render.c utils.c map_checker.c load_map.c map_checker_2.c map_checker_3.c map_gauntlet.c
